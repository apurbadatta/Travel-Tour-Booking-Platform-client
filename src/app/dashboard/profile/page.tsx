    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="bg-surface dark:bg-[#1E293B] rounded-xl p-5 border border-gray-100 dark:border-gray-700 transition-colors">
          ...
          <div className="bg-surface dark:bg-[#1E293B] rounded-xl p-5 border border-gray-100 dark:border-gray-700 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-text-primary">{stats.completedTrips}</p>
              </div>
            </div>
          </div>
          <div className="bg-surface dark:bg-[#1E293B] rounded-xl p-5 border border-gray-100 dark:border-gray-700 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-surface dark:bg-[#1E293B] rounded-xl p-6 border border-gray-100 dark:border-gray-700 transition-colors">
              <div className="text-center">
                <div className="relative w-24 h-24 mx-auto mb-4">
                  {image ? (
                    <img src={image} alt={name} className="w-24 h-24 rounded-full object-cover border-4 border-primary/20" />
                  ) : (
                ...
                <h2 className="text-xl font-bold text-text-primary">{u.name}</h2>
                <p className="text-text-secondary text-sm mt-1">{u.email}</p>
                <div className="inline-flex items-center gap-1.5 mt-3 px-3 py-1 rounded-full text-xs font-semibold bg-primary/10 text-primary">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600 space-y-3">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-text-primary font-medium ml-auto">{u.email}</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <Phone className="h-4 w-4 text-text-secondary" />
                  <span className="text-text-secondary">Phone:</span>
                  <span className="text-text-primary font-medium ml-auto">{profile.phone || 'Not set'}</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
          ...
          <div className="lg:col-span-2">
            <div className="bg-surface dark:bg-[#1E293B] rounded-xl p-6 border border-gray-100 dark:border-gray-700 transition-colors">
              <h3 className="text-lg font-semibold text-text-primary mb-6">Edit Profile</h3>
              ...
              <form onSubmit={handleSave} className="space-y-5">
                  ...
                  <div className="flex gap-3">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 border border-gray-200 dark:border-gray-600 bg-background dark:bg-[#0F172A] text-text-primary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={u.email}
                      disabled
                      className="w-full pl-10 pr-4 py-2.5 border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-text-secondary rounded-lg cursor-not-allowed"
                    />
                  </div>
                ...
                <div className="flex justify-end pt-4">
                  <button
                    type="submit"
                    disabled={saving}
                    className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded-lg font-medium hover:bg-primary/90 disabled:opacity-50 transition-colors"
                  >
                    {saving ? (
